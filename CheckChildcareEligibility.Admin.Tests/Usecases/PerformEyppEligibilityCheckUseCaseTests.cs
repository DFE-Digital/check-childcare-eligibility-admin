...
[TestFixture]
public class PerformEyppEligibilityCheckUseCaseTests
{
    ...
    public void SetUp()
    {
        ...
        _sut = new PerformEyppEligibilityCheckUseCase(_checkGatewayMock.Object);
        ...
        // Pre-populate session with common values
    ...
    private PerformEyppEligibilityCheckUseCase _sut;
