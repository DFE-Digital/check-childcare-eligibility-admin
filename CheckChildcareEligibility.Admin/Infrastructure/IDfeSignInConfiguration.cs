...
public interface IDfeSignInConfiguration
{
    ...
    /// <remarks>
    ///     <para>
    ///         This should reflect the configuration in the DfE Sign-in "Manage service"
    ///         web interface.
    ///     </para>
    /// </remarks>
    string ClientId { get; }
    ...
    /// <remarks>
    ///     <para>
    ///         The .NET library deals with setting up this endpoint automatically; this
    ///         property just indicates what the endpoint will be.
    ///     </para>
    ///     <para>
    ///         This should reflect the configuration in the DfE Sign-in "Manage service"
    ///         web interface.
